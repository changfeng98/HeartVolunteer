$("#volunteer_register").click(function (e) {
    location.href = "register_volunteer.html";
});

$("#organization_register").click(function (e) {
    location.href = "register_organization.html";
});
...
$(".register_body").on("click", ".register_next_btn_to_complete", function () {
    ...
    //ajax
    //prepared data: email,nickname,password,phoneNumber,idCard,gender
    var data= {email:email_final,nickname:nickname_final,password:password_final,phoneNumber:phoneNumber_final,idCard:idCardNumber_final,gender:gender_final};
    console.log("RegisterAjax");
    $.ajax({
        url: "/InformationCheck/login", //后台请求数据
        dataType: "json",
...
function onStepThreeBlur(){
    ...
    console.log(gender);
    if((phoneNumber == "" || phoneNumber == null) || (idCardNumber == "" || idCardNumber == null) ||(gender == "" || gender == null)){
