...
//}
//else{
//    $sql = "insert into community (topic_name, topic_class, topic_image, user_name, topic_content, likes, release_data) VALUES ('$topic_name', '$topic_class', '$topic_image', '$user_name' , '$topic_content', '$likes', '$release_date')";
//    //echo $sql;
//   // var_dump($sql);
//    //$link->query($sql);
//    $obj=mysqli_query($link,$sql);
